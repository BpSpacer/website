...
const LoadedCartData = () => {
  ...
  const totalItems = useAppSelector((state: { cart: { totalQuantity: any; }; }) => state.cart.totalQuantity);
  const totalPrice = useAppSelector((state: { cart: { totalAmount: any; }; }) => state.cart.totalAmount);
